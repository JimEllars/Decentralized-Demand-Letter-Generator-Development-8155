  ...
  <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
    ...
    >
      <div className="bg-blue-900 p-8 text-white text-center">
        ...
        <p className="text-blue-200 text-xs mt-1">AXiM Documents Encryption Active</p>
      </div>

      <div className="p-8 space-y-6">
        <div className="flex justify-between items-center bg-slate-50 p-4 rounded-xl border border-slate-100">
          <span className="text-slate-600 font-medium">Template Access</span>
          <span className="font-bold text-2xl text-blue-900">$29.00</span>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 text-[10px] text-slate-400 uppercase font-bold">
          <SafeIcon icon={FiShield} /> 256-Bit SSL Secure
        </div>
      </div>
    </motion.div>
  </div>
