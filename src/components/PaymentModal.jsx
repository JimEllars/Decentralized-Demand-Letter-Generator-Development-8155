        ...
        <div className="p-6 space-y-5">
          ...
          <label className="flex items-start gap-3 cursor-pointer group bg-red-500/5 border border-red-500/20 p-3 rounded-sm shrink-0">
            ...
            <span className="text-[0.65rem] leading-snug font-medium text-zinc-300">
              I verify that the information entered is correct and I agree to proceed with the order. I understand and accept the AXiM Satisfaction Guarantee: if there are any technical issues with my generated document, support will make it right.
            </span>
          </label>
