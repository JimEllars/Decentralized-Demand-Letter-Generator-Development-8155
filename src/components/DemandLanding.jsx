...
const STEPS = [
  ...
  { step: '04', title: 'Export PDF', description: 'Pay a limited-time $4.00 promo fee (normally $8.00). Instantly download your legally-formatted PDF and receive an immediate backup copy delivered straight to your inbox.' }
];
...
const FAQS = [
  ...
  { question: 'How quickly do I get my document?', answer: 'Instantly. As soon as your secure $4.00 payment clears, your finalized, professional PDF is immediately available for download directly to your device, and a backup copy is automatically sent to your email.' }
];
            ...
            "@graph": [
              {
                ...
                "description": "Generate a professional, state-specific demand letter instantly. Limited time promo: $4.00 (normally $8.00). Includes instant download and secure email delivery via Zero-Knowledge architecture.",
                "publisher": {
                  "@type": "Organization",
                  "name": "AXiM Documents"
                }
            ...
            <table className="w-full min-w-[600px] text-left border-collapse">
              ...
              <tbody className="text-sm font-inter">
                <tr className="border-b border-white/5 transition-colors hover:bg-white/5">
                  ...
                  <td className="py-5 px-6 font-mono font-bold text-white bg-axim-gold/5"><del className="text-zinc-500 font-normal mr-2">$8.00</del>$4.00 PROMO</td>
                </tr>
                <tr className="border-b border-white/5 transition-colors hover:bg-white/5">
