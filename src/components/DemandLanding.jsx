...
const STEPS = [
  ...
  { step: '04', title: 'Export PDF', description: 'originally $8 but the promotional price TODAY is $2. Instantly download your legally-formatted PDF and receive an immediate backup copy delivered straight to your inbox.' }
];
...
const FAQS = [
  ...
  { question: 'How quickly do I get my document?', answer: 'Instantly. As soon as your secure $2 payment clears, your finalized, professional PDF is immediately available for download directly to your device, and a backup copy is automatically sent to your email.' }
];
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-inter selection:bg-axim-gold selection:text-black overflow-x-hidden">
      <Helmet>
        ...
        <meta name="twitter:description" content="Generate a professional demand letter instantly for $2. Skip the lawyer fees." />
            ...
            "@graph": [
              {
                ...
                "description": "Generate a professional, state-specific demand letter instantly. originally $8 but the promotional price TODAY is $2. Includes instant download and secure email delivery via Zero-Knowledge architecture.",
                "publisher": {
                  "@type": "Organization",
                  "name": "AXiM Documents"
                }
      ...
      <section className="relative pt-24 pb-32 px-4 flex flex-col items-center justify-center text-center min-h-[90vh]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            A quick, affordable solution when you need to draft a demand letter fast. Skip the legwork and let us handle your professionally formatted PDF <strong className="text-white font-bold">originally $8 but the promotional price TODAY is $2.</strong> Includes instant download and an immediate email copy.
          </motion.p>
      ...
      <section className="py-24 px-4 bg-white/[0.01] border-y border-white/5 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto">Why $2? We removed human operational overhead and pass raw compute savings directly to you.</p>
          </div>
            ...
            <table className="w-full min-w-[600px] text-left border-collapse">
              ...
              <tbody className="text-sm font-inter">
                <tr className="border-b border-white/5 transition-colors hover:bg-white/5">
                  ...
                  <td className="py-5 px-6 font-mono font-bold text-white bg-axim-gold/5">originally $8 but the promotional price TODAY is $2</td>
                </tr>
                <tr className="border-b border-white/5 transition-colors hover:bg-white/5">
      ...
      <section className="py-32 px-4 relative z-10 flex flex-col items-center justify-center text-center min-h-[60vh] border-t border-white/5">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-10 uppercase text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">
            ...
            <span className="text-zinc-500 text-3xl md:text-5xl mt-2 block">For $2</span>
          </h2>
