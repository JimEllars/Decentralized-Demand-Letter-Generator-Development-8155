...
const TerminalLine = ({ text, delay }) => {
  ...
  return (
    <div className="font-mono text-sm mb-2 text-axim-teal flex">
      <span className="opacity-70">{displayedText}</span>
      {displayedText.length < text.length && (
        <motion.span
          animate={{ opacity: [1, 0] }}
          transition={{ repeat: Infinity, duration: 0.8 }}
          className="w-2 h-4 bg-axim-teal ml-1 inline-block"
        />
      )}
    </div>
  );
...
const STEPS = [
  { step: '01', title: 'The Parties', description: 'Enter the details of the creditor and the debtor. Our secure form ensures your data never leaves your browser.' },
  { step: '02', title: 'The Debt', description: 'Detail the amount owed, the reason for the debt, and any relevant dates or invoices.' },
  { step: '03', title: 'Tone & Review', description: 'Select the tone of your letter (Firm, Aggressive, etc.) and review the live draft.' },
  { step: '04', title: 'Export PDF', description: 'Pay a limited-time $2.00 promo fee (normally $8.00). Instantly download your legally-formatted PDF and receive an immediate backup copy delivered straight to your inbox.' }
];

const USE_CASES = [
  { title: 'Freelance Invoices', icon: <FileText size={20} /> },
  { title: 'Security Deposits', icon: <Home size={20} /> },
  { title: 'Contract Breach', icon: <Briefcase size={20} /> },
  { title: 'Property Damage', icon: <FileWarning size={20} /> }
];

const FAQS = [
  { question: 'Is this legally binding?', answer: 'A demand letter is a formal request for payment or action, and it can be used as evidence in court if the dispute escalates to litigation.' },
  { question: 'Do I need an attorney?', answer: 'While an attorney can provide legal advice, a formal demand letter generated by our platform is often sufficient to resolve disputes without legal representation.' },
  { question: 'Is my data secure?', answer: 'Yes. Our platform uses a Zero-Knowledge architecture, meaning your sensitive PII (Personally Identifiable Information) is processed entirely within your browser and is never stored on our servers.' },
  { question: 'What if they don\'t pay?', answer: 'If the debtor fails to respond or refuses to pay after receiving the demand letter, you may choose to escalate the matter to small claims court or seek legal counsel.' },
  { question: 'How quickly do I get my document?', answer: 'Instantly. As soon as your secure $2.00 payment clears, your finalized, professional PDF is immediately available for download directly to your device, and a backup copy is automatically sent to your email.' }
];
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white font-inter selection:bg-axim-gold selection:text-black overflow-x-hidden">
      <Helmet>
        ...
        <meta name="twitter:description" content="Generate a professional demand letter instantly for $2.00. Skip the lawyer fees." />
            ...
            "@graph": [
              {
                ...
                "description": "Generate a professional, state-specific demand letter instantly. Limited time promo: $2.00 (normally $8.00). Includes instant download and secure email delivery via Zero-Knowledge architecture.",
                "publisher": {
                  "@type": "Organization",
                  "name": "AXiM Documents"
                }
      ...
      <section className="relative pt-24 pb-32 px-4 flex flex-col items-center justify-center text-center min-h-[90vh]">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            A quick, affordable solution when you need to draft a demand letter fast. Skip the legwork and let us handle your professionally formatted PDF <strong className="text-white font-bold">for a limited-time promo of just $2.00 TODAY ($8 original).</strong> Includes instant download and an immediate email copy.
          </motion.p>
      ...
      <section className="py-24 px-4 bg-white/[0.01] border-y border-white/5 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto">Why $2.00? We removed human operational overhead and pass raw compute savings directly to you.</p>
          </div>
            ...
            <table className="w-full min-w-[600px] text-left border-collapse">
              ...
              <tbody className="text-sm font-inter">
                <tr className="border-b border-white/5 transition-colors hover:bg-white/5">
                  ...
                  <td className="py-5 px-6 font-mono font-bold text-white bg-axim-gold/5"><del className="text-zinc-500 font-normal mr-2">$8.00</del>$2.00 PROMO</td>
                </tr>
                <tr className="border-b border-white/5 transition-colors hover:bg-white/5">
      ...
      <section className="py-32 px-4 relative z-10 flex flex-col items-center justify-center text-center min-h-[60vh] border-t border-white/5">
        ...
        <div className="relative z-10">
          <h2 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-10 uppercase text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.2)]">
            ...
            <span className="text-zinc-500 text-3xl md:text-5xl mt-2 block">For $2.00</span>
          </h2>
