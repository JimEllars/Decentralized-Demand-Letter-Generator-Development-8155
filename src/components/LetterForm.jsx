...
const LetterForm = memo(({ formData, onUpdate, errors = {}, currentStep, calculatedValues }) => {
  ...
  const getInputClass = (fieldName, value, isRequired = false) => {
    const baseClass = "bg-black/50 border text-white font-mono text-sm p-4 w-full rounded-md shadow-inner transition-all duration-200 outline-none focus:ring-2 focus:ring-axim-teal/20 placeholder:text-zinc-600 focus:ring-2";
