...
const UpsellCard = ({ total = 0 }) => {
    ...
    return (
      <motion.div whileHover={{ y: -2 }} className="bg-black/50 rounded-xl p-8 text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl border border-axim-teal/40 relative overflow-hidden">
        ...
        <a
          ...
          className="relative z-10 bg-axim-teal/10 text-axim-teal border border-axim-teal px-6 py-3 rounded-lg text-xs font-inter font-bold uppercase tracking-wider whitespace-nowrap hover:bg-axim-teal hover:text-black transition-all shadow-[0_0_15px_rgba(0,229,255,0.2)] flex items-center gap-2"
        >
  ...
  return (
    <motion.div whileHover={{ y: -2 }} className="bg-black/50 rounded-xl p-8 text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-2xl border border-subtle">
      ...
      <a
        href="https://axim.us.com/tools"
        target="_blank"
        rel="noopener noreferrer"
        className="bg-black text-axim-gold border border-axim-gold px-6 py-3 rounded-lg text-xs font-inter font-bold uppercase tracking-wider whitespace-nowrap hover:bg-axim-gold hover:text-black transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(255,215,0,0.1)]"
      >
